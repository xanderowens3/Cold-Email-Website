      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        >
          <motion.div variants={item} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 mb-8">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-blue-700">Scaling Agencies with AI</span>
          </motion.div>
          ...
          >
            Book <span className="relative inline-block mx-1">
              <span className="relative z-10">Qualified Sales</span>
              <HandDrawnUnderline />
            </span><br className="hidden md:block" />
            Calls Automatically<br className="hidden md:block" />
            <span className="italic font-medium text-blue-600">Without The Tech Headache</span>
          </motion.h1>
          ...
          >
            Our AI cold email system automates personalized outreach for digital marketing agencies, so you can fill your pipeline with ready-to-buy prospects while focusing on what you do best.
          </motion.p>
